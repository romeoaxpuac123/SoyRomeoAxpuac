                ...
                if(entorno.ObtenerListaN(Vector) ==0){
                    ...
                    for(int i = 0 ; i < ExpresionesRomeo.size();i++){
                        ...
                        if("cadena".equals(Tipo1y)){
                            String ElValor = "#Error";
                            System.out.println("Aca Operamos Cadenas" + ValorVectori + "Dato2->" + val2);
                            NodoAbstracto nuevo = new Nodo("Cadena");
                            NodoAbstracto nuevovalor = new Nodo(ValorVectori+val2);
                            nuevo.Hijos.add(nuevovalor);
                            nuevo.TipoDato = "cadena";
                            ExpresionesLola.add(nuevo);
                        }else if("entero".equals(Tipo1y)){
                            if("cadena".equals(Tipo2)){
                                NodoAbstracto nuevo = new Nodo("Cadena");
                                NodoAbstracto nuevovalor = new Nodo(ValorVectori+val2);
                                nuevo.Hijos.add(nuevovalor);
                                nuevo.TipoDato = "cadena";
                                ExpresionesLola.add(nuevo);
                            }else if("entero".equals(Tipo2)){
                                int totalx = Integer.parseInt(ValorVectori) + Integer.parseInt(val2);
                                NodoAbstracto nuevo = new Nodo("Entero");
                                NodoAbstracto nuevovalor = new Nodo(String.valueOf(totalx));
                                nuevo.Hijos.add(nuevovalor);
                                nuevo.TipoDato = "entero";
                                ExpresionesLola.add(nuevo);
                            
                            }else if("decimal".equals(Tipo2)){
                              //  System.out.println("VAMONOS DE VIAJE---------->" + val2);
                                double valor1z = Double.parseDouble(ValorVectori);
                                double valor2z =  Double.parseDouble(val2);
                                double totalx =  valor1z + valor2z;
                                //System.out.println("VAMONOS DE VIAJE---------->" + valor1z + "->"+ valor2z + "->" + totalx);
                                ...
                                nuevo.TipoDato = "cadena";
                                ExpresionesLola.add(nuevo);
                            }else if("entero".equals(Tipo2) || "decimal".equals(Tipo2)){
                                double valor1z = Double.parseDouble(ValorVectori);
                                double valor2z =  Double.parseDouble(val2);
                                double totalx =  valor1z + valor2z;
                                //System.out.println("VAMONOS DE VIAJE---------->" + valor1z + "->"+ valor2z + "->" + totalx);
